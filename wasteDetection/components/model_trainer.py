...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        logging.info("Entered initaite _model_trainer method of ModelTrainer class")
        ...
        try:
            ...
            os.system(f"cd yolov5/ && pthon train.py --img416 --batch{self.model_trainer_config.batch_size}--epochs {self.model_trainer_config.no_epochs} --data ../data.yaml --cfg ./models/custom_yolov5s.yaml --weights {self.model_trainer_config.weight_name} --name yolovs_results --cache") 
            ...
            logging.info("Exited initaite_model_trainer method of ModelTrainer class")
